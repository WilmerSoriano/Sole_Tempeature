import sys
import resources_rc # Used with assets/resources.qrc to help QT find background images
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.picture.setPixmap(QtGui.QPixmap(":/assets/bg.jpg")) # resources_rc file help QT find image with (:/) format
